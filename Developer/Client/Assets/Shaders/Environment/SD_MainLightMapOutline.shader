Shader "SD/Environment/SD_MainLightMapOutline" 
{
	Properties 
	{
		...
		[HideInInspector][Header(Dissolve)]
		[HideInInspector][MaterialToggle(USE_DISSOLVE)]_UseDissolve("Use Dissolve", Int) = 0
		[HideInInspector]_DissolveAmount("_DissolveAmount", Range(0, 1)) = 0.1
		[HideInInspector]_DissolveNoise("Dissolve Noise", 2D) = "white"{}
		[HideInInspector]_DissolveEdgeWidth("Dissolve Edge Wdith",  Range(0.001, 1)) = 0
		[HideInInspector]_DissolveHeightSpeed("Dissolve Height Factor(为0高度不生效)", Float) = 0
		[HideInInspector]_DissolveHeight("Dissolve Height",  Range(-20, 20)) = 0
		[HideInInspector][HDR]_DissolveEdgeColor("Dissolve Edge Color", Color) = (0.0, 0.0, 0.0, 0.5)
		[HideInInspector]_DissolveSmoothness("Dissolve Smoothness", Range(0.001, 1)) = 0.2		
	}
	SubShader
	{
		Tags 
