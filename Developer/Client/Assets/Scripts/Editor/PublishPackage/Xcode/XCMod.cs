...
namespace UnityEditor.XCodeEditor 
{
	public class XCMod 
	{
		...
		public XCMod( string filename, string projectPath = null)
		{	
			...
			Dictionary<string, object> dictJson = JsonFx.Json.JsonReader.Deserialize(contents) as Dictionary<string,object>;;
