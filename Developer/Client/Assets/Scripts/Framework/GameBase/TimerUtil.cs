...
namespace TopGame.Base
{
    public static class TimerUtil
    {
        ...
        /// <returns></returns>
        public static string GetTimeString(long time, bool nLimit = false)
        {
            
            if (nLimit? time >= 3600 : time > 3600)
            {
                if (time % 3600 / 60 == 0)
                {
            ...
            else if(nLimit? time >= 60 : time > 60)
            {
                if (time % 60 == 0)
                {
        ...
        //------------------------------------------------------
        public static string GetTimeStringFromTimeStampSeconds(long timeStamp, string format = "yyyy-MM-dd HH:mm:ss:ffff")
        {
            return DateTimeOffset.FromUnixTimeMilliseconds(timeStamp).LocalDateTime.ToString(format);
        }
        //-----------------------------------------------------
        /// <summary>
