    ...
    public class ScaleTween : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            if (m_DelayTimer >= PlayDelay)
            {
                ...
                {
                    float value = ScaleCurve.Evaluate(ScaleCurve.keys[ScaleCurve.keys.Length - 1].time);
        ...
        public void Play()
        {
            ...
            if (index > 0)
            {
                ...
                {
                    PlayDelay = DelayTime*(index - 1) * ScaleCurve.keys[ScaleCurve.keys.Length - 2].time;
                }
            }
