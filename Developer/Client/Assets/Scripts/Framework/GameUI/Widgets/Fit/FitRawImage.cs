...
namespace TopGame.UI
{
    [UIWidgetExport]
	[ExecuteAlways]
    public class FitRawImage : RawImage
    {
...
#if UNITY_EDITOR
    [CustomEditor(typeof(FitRawImage), true)]
    [CanEditMultipleObjects]
    public class FitRawImageEditor : RawImageEditor
    {
        public override void OnInspectorGUI()
        {
            serializedObject.Update();

            FitRawImage image = target as FitRawImage;
