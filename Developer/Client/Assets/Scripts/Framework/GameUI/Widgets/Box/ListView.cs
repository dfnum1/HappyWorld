...
{
    [TopGame.UI.UIWidgetExport]
    [AddComponentMenu("UI/List View", 38)]
    [SelectionBase]
    [ExecuteInEditMode]
    [DisallowMultipleComponent]
    [RequireComponent(typeof(RectTransform))]
    public class ListView : UIBehaviour, IInitializePotentialDragHandler, IBeginDragHandler, IEndDragHandler, IDragHandler, IScrollHandler, ICanvasElement, ILayoutGroup, IGuideScroll
    {
        #region 定义结构
        ...
        [Serializable]
        public class ScrollRenderEvent : UnityEvent<int, TopGame.UI.UISerialized> { }
        ...
        private class ItemInfo
        {
            ...
            public TopGame.UI.UISerialized serialized;
            ...
            public ItemInfo(RectTransform trans)
            {
                ...
                if(transform)
                {
                    serialized = transform.GetComponent<TopGame.UI.UISerialized>();
                    if (serialized == null) serialized = transform.gameObject.AddComponent<TopGame.UI.UISerialized>();
                }
        ...
        void OnInitializePotentialDragItem(GameObject go, BaseEventData eventData, params VariablePoolAble[] param)
        {
        ...
        void OnBeginDragItem(GameObject go, BaseEventData eventData, params VariablePoolAble[] param)
        {
        ...
        void OnEndDragItem(GameObject go, BaseEventData eventData, params VariablePoolAble[] param)
        {
        ...
        void OnDragItem(GameObject go, BaseEventData eventData, params VariablePoolAble[] param)
        {
        ...
        protected void LateUpdate()
        {
            ...
            if (m_EnterScale)
            {
                if(m_vEnterScale!=null)
                {
                    ...
                    EnterScale enter;
                    float curveTime = Framework.Core.BaseUtil.GetCurveMaxTime(m_EnterScaleAnimation);
        ...
        private IEnumerator RebuildList()
        {
            if (!Application.isPlaying || !m_HasInit || !m_Content || !m_Prefab || !m_ViewPort)
                yield return null;
            yield return Framework.Module.CoroutineSystem.waitForEndOfFrame;
