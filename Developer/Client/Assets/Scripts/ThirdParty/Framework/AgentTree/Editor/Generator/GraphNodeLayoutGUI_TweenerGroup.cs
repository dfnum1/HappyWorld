...
namespace Framework.Plugin.AT
{
	...
	{
		[GraphNodeDrawGUIMethod(106153887)]
		public static bool TopGame_RtgTween_TweenerGroup_isPlaying_Boolean(GraphNode pNode)
		{
			bool bChanged = false;
		...
		[GraphNodeDrawGUIMethod(-1659186380)]
		public static bool TopGame_RtgTween_TweenerGroup_ForcePlay_Int16Void(GraphNode pNode)
		{
			bool bChanged = false;
		...
		[GraphNodeDrawGUIMethod(-1687918740)]
		public static bool TopGame_RtgTween_TweenerGroup_Play_Int16BooleanVoid(GraphNode pNode)
		{
			bool bChanged = false;
		...
		[GraphNodeDrawGUIMethod(1908055081)]
		public static bool TopGame_RtgTween_TweenerGroup_Stop_Void(GraphNode pNode)
		{
			bool bChanged = false;
			if(!bChanged && (pNode.BindNode.inArgvs == null || pNode.BindNode.inArgvs.Length != 1)) bChanged = true;
			if(bChanged)
