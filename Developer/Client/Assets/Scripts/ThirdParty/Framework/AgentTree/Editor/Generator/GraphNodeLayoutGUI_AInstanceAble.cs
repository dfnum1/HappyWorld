...
namespace Framework.Plugin.AT
{
	...
	{
		[GraphNodeDrawGUIMethod(-1531199794)]
		public static bool Framework_Core_AInstanceAble_GetTransorm_Transform(GraphNode pNode)
		{
			bool bChanged = false;
		...
		[GraphNodeDrawGUIMethod(1184135236)]
		public static bool Framework_Core_AInstanceAble_SetPosition_Vector3BooleanVoid(GraphNode pNode)
		{
			bool bChanged = false;
		...
		[GraphNodeDrawGUIMethod(1024259411)]
		public static bool Framework_Core_AInstanceAble_SetRotation_QuaternionBooleanVoid(GraphNode pNode)
		{
			bool bChanged = false;
			if(!bChanged && (pNode.BindNode.inArgvs == null || pNode.BindNode.inArgvs.Length != 3)) bChanged = true;
			if(bChanged)
			{
				...
				{
					Port pvar=null;
					pvar = AgentTreeEditorUtils.BuildOriVariableCommonNew<Framework.Plugin.AT.VariableQuaternion>(pVarsFactor, vInTemp, 1);
					pNode.BindNode.AddInPort(pvar);
				}
				{
					Port pvar=null;
		...
		[GraphNodeDrawGUIMethod(372460568)]
		public static bool Framework_Core_AInstanceAble_SetForward_Vector3Void(GraphNode pNode)
		{
			bool bChanged = false;
		...
		[GraphNodeDrawGUIMethod(1194349079)]
		public static bool Framework_Core_AInstanceAble_SetUp_Vector3Void(GraphNode pNode)
		{
			bool bChanged = false;
			if(!bChanged && (pNode.BindNode.inArgvs == null || pNode.BindNode.inArgvs.Length != 2)) bChanged = true;
			if(bChanged)
		...
		[GraphNodeDrawGUIMethod(-1326731487)]
		public static bool Framework_Core_AInstanceAble_SetEulerAngle_Vector3BooleanVoid(GraphNode pNode)
		{
			bool bChanged = false;
			if(!bChanged && (pNode.BindNode.inArgvs == null || pNode.BindNode.inArgvs.Length != 3)) bChanged = true;
			if(bChanged)
		...
		[GraphNodeDrawGUIMethod(802805407)]
		public static bool Framework_Core_AInstanceAble_SetScale_Vector3Void(GraphNode pNode)
		{
			bool bChanged = false;
			if(!bChanged && (pNode.BindNode.inArgvs == null || pNode.BindNode.inArgvs.Length != 2)) bChanged = true;
			if(bChanged)
		...
		[GraphNodeDrawGUIMethod(-1859231129)]
		public static bool Framework_Core_AInstanceAble_Reset_BooleanVoid(GraphNode pNode)
		{
			bool bChanged = false;
			if(!bChanged && (pNode.BindNode.inArgvs == null || pNode.BindNode.inArgvs.Length != 2)) bChanged = true;
			if(bChanged)
		...
		[GraphNodeDrawGUIMethod(-703615783)]
		public static bool Framework_Core_AInstanceAble_SetActive_Void(GraphNode pNode)
		{
			bool bChanged = false;
			if(!bChanged && (pNode.BindNode.inArgvs == null || pNode.BindNode.inArgvs.Length != 1)) bChanged = true;
			if(bChanged)
		...
		[GraphNodeDrawGUIMethod(805507562)]
		public static bool Framework_Core_AInstanceAble_SetUnActive_Void(GraphNode pNode)
		{
			bool bChanged = false;
			if(!bChanged && (pNode.BindNode.inArgvs == null || pNode.BindNode.inArgvs.Length != 1)) bChanged = true;
			if(bChanged)
		...
		[GraphNodeDrawGUIMethod(501735087)]
		public static bool Framework_Core_AInstanceAble_SetParent_TransformBooleanVoid(GraphNode pNode)
		{
			bool bChanged = false;
			if(!bChanged && (pNode.BindNode.inArgvs == null || pNode.BindNode.inArgvs.Length != 3)) bChanged = true;
			if(bChanged)
		...
		[GraphNodeDrawGUIMethod(-599780727)]
		public static bool Framework_Core_AInstanceAble_ClearMaterialBlock_Void(GraphNode pNode)
		{
			bool bChanged = false;
			if(!bChanged && (pNode.BindNode.inArgvs == null || pNode.BindNode.inArgvs.Length != 1)) bChanged = true;
			if(bChanged)
		...
		[GraphNodeDrawGUIMethod(880711736)]
		public static bool Framework_Core_AInstanceAble_SetColor_StringColorBooleanBooleanInt32Void(GraphNode pNode)
		{
			bool bChanged = false;
		...
		[GraphNodeDrawGUIMethod(1352012916)]
		public static bool Framework_Core_AInstanceAble_SetVector_StringVector4BooleanBooleanInt32Void(GraphNode pNode)
		{
			bool bChanged = false;
			if(!bChanged && (pNode.BindNode.inArgvs == null || pNode.BindNode.inArgvs.Length != 6)) bChanged = true;
			if(bChanged)
		...
		[GraphNodeDrawGUIMethod(-2089642805)]
		public static bool Framework_Core_AInstanceAble_SetFloat_StringSingleBooleanBooleanInt32Void(GraphNode pNode)
		{
			bool bChanged = false;
			if(!bChanged && (pNode.BindNode.inArgvs == null || pNode.BindNode.inArgvs.Length != 6)) bChanged = true;
			if(bChanged)
		...
		[GraphNodeDrawGUIMethod(902137129)]
		public static bool Framework_Core_AInstanceAble_SetInt_StringInt32BooleanBooleanInt32Void(GraphNode pNode)
		{
			bool bChanged = false;
			if(!bChanged && (pNode.BindNode.inArgvs == null || pNode.BindNode.inArgvs.Length != 6)) bChanged = true;
			if(bChanged)
		...
		[GraphNodeDrawGUIMethod(-1859986116)]
		public static bool Framework_Core_AInstanceAble_SetTexture_StringTextureBooleanBooleanInt32Void(GraphNode pNode)
		{
			bool bChanged = false;
			if(!bChanged && (pNode.BindNode.inArgvs == null || pNode.BindNode.inArgvs.Length != 6)) bChanged = true;
			if(bChanged)
		...
		[GraphNodeDrawGUIMethod(-1251211296)]
		public static bool Framework_Core_AInstanceAble_SetMaterial_MaterialInt32BooleanVoid(GraphNode pNode)
		{
			bool bChanged = false;
		...
		[GraphNodeDrawGUIMethod(-958156853)]
		public static bool Framework_Core_AInstanceAble_LerpToMaterial_MaterialSingleInt32SingleStringBooleanVoid(GraphNode pNode)
		{
			bool bChanged = false;
		...
		[GraphNodeDrawGUIMethod(1247696414)]
		public static bool Framework_Core_AInstanceAble_RemoveMaterialByIndex_Int32Void(GraphNode pNode)
		{
			bool bChanged = false;
			if(!bChanged && (pNode.BindNode.inArgvs == null || pNode.BindNode.inArgvs.Length != 2)) bChanged = true;
			if(bChanged)
		...
		[GraphNodeDrawGUIMethod(-1914014566)]
		public static bool Framework_Core_AInstanceAble_RemoveMaterial_MaterialVoid(GraphNode pNode)
		{
			bool bChanged = false;
			if(!bChanged && (pNode.BindNode.inArgvs == null || pNode.BindNode.inArgvs.Length != 2)) bChanged = true;
			if(bChanged)
		...
		[GraphNodeDrawGUIMethod(522038616)]
		public static bool Framework_Core_AInstanceAble_ReplaceShader_StringInt32Void(GraphNode pNode)
		{
			bool bChanged = false;
			if(!bChanged && (pNode.BindNode.inArgvs == null || pNode.BindNode.inArgvs.Length != 3)) bChanged = true;
			if(bChanged)
		...
		[GraphNodeDrawGUIMethod(-1791680667)]
		public static bool Framework_Core_AInstanceAble_EnableKeyWorld_StringBooleanInt32Void(GraphNode pNode)
		{
			bool bChanged = false;
			if(!bChanged && (pNode.BindNode.inArgvs == null || pNode.BindNode.inArgvs.Length != 4)) bChanged = true;
			if(bChanged)
