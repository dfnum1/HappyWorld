...
namespace Framework.Plugin.AT
{
	...
	{
		[GraphNodeDrawGUIMethod(1941524615)]
		public static bool TopGame_Data_CsvData_Dialog_GetData_UInt32DialogData(GraphNode pNode)
		{
			bool bChanged = false;
		...
		[GraphNodeDrawGUIMethod(1029092545)]
		public static bool CsvData_Dialog_Draw_get_datas(GraphNode pNode)
		{
			bool bChanged = false;
