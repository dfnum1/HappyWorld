...
namespace Framework.Plugin.AT
{
	...
	{
		[GraphNodeDrawGUIMethod(823841711)]
		public static bool TopGame_RtgTween_Tweener_IsPlaying_Boolean(GraphNode pNode)
		{
			bool bChanged = false;
		...
		[GraphNodeDrawGUIMethod(1425730982)]
		public static bool TopGame_RtgTween_Tweener_PlayTween_SingleVoid(GraphNode pNode)
		{
			bool bChanged = false;
		...
		[GraphNodeDrawGUIMethod(1544577910)]
		public static bool TopGame_RtgTween_Tweener_ForcePlayTween_SingleVoid(GraphNode pNode)
		{
			bool bChanged = false;
			if(!bChanged && (pNode.BindNode.inArgvs == null || pNode.BindNode.inArgvs.Length != 2)) bChanged = true;
			if(bChanged)
		...
		[GraphNodeDrawGUIMethod(362508259)]
		public static bool TopGame_RtgTween_Tweener_StopTween_Void(GraphNode pNode)
		{
			bool bChanged = false;
			if(!bChanged && (pNode.BindNode.inArgvs == null || pNode.BindNode.inArgvs.Length != 1)) bChanged = true;
			if(bChanged)
