...
namespace Framework.Plugin.AT
{
	...
	{
		[GraphNodeDrawGUIMethod(-1641981117)]
		public static bool Framework_Core_InstanceOperiaon_Refresh_Void(GraphNode pNode)
		{
			bool bChanged = false;
			if(bChanged)
			{
		...
		[GraphNodeDrawGUIMethod(441904745)]
		public static bool InstanceOperiaon_Draw_get_strFile(GraphNode pNode)
		{
			bool bChanged = false;
		...
		[GraphNodeDrawGUIMethod(1387835288)]
		public static bool InstanceOperiaon_Draw_get_pAssetPrefab(GraphNode pNode)
		{
			bool bChanged = false;
			if(!bChanged && (pNode.BindNode.outArgvs == null || pNode.BindNode.outArgvs.Length != 1)) bChanged = true;
			if(bChanged)
			{
				...
				{
					Port pvar=null;
					pvar = AgentTreeEditorUtils.BuildOriVariableCommonNew<Framework.Plugin.AT.VariableObject>(pVarsFactor, vOutTemp,0);
					pNode.BindNode.AddOutPort(pvar);
				}
				pNode.BindNode.Save();
			}
		...
		[GraphNodeDrawGUIMethod(-1154960949)]
		public static bool InstanceOperiaon_Draw_get_pPoolAble(GraphNode pNode)
		{
			bool bChanged = false;
			if(!bChanged && (pNode.BindNode.outArgvs == null || pNode.BindNode.outArgvs.Length != 1)) bChanged = true;
			if(bChanged)
		...
		[GraphNodeDrawGUIMethod(1187351282)]
		public static bool InstanceOperiaon_Draw_get_userPointer(GraphNode pNode)
		{
			bool bChanged = false;
			if(!bChanged && (pNode.BindNode.outArgvs == null || pNode.BindNode.outArgvs.Length != 1)) bChanged = true;
			if(bChanged)
		...
		[GraphNodeDrawGUIMethod(1187351282)]
		public static bool InstanceOperiaon_Draw_set_userPointer(GraphNode pNode)
		{
			bool bChanged = false;
		...
		[GraphNodeDrawGUIMethod(140507103)]
		public static bool InstanceOperiaon_Draw_get_bUsed(GraphNode pNode)
		{
			bool bChanged = false;
			if(!bChanged && (pNode.BindNode.outArgvs == null || pNode.BindNode.outArgvs.Length != 1)) bChanged = true;
			if(bChanged)
		...
		[GraphNodeDrawGUIMethod(140507103)]
		public static bool InstanceOperiaon_Draw_set_bUsed(GraphNode pNode)
		{
			bool bChanged = false;
			if(!bChanged && (pNode.BindNode.inArgvs == null || pNode.BindNode.inArgvs.Length != 1)) bChanged = true;
			if(bChanged)
			{
				...
				{
					Port pvar=null;
					pvar = AgentTreeEditorUtils.BuildOriVariableCommonNew<Framework.Plugin.AT.VariableBool>(pVarsFactor, vInTemp, 0);
					pNode.BindNode.AddInPort(pvar);
					pNode.BindNode.AddOutPort(pvar);
				}
				pNode.BindNode.Save();
		...
		[GraphNodeDrawGUIMethod(-603414435)]
		public static bool InstanceOperiaon_Draw_get_bScene(GraphNode pNode)
		{
			bool bChanged = false;
			if(!bChanged && (pNode.BindNode.outArgvs == null || pNode.BindNode.outArgvs.Length != 1)) bChanged = true;
			if(bChanged)
		...
		[GraphNodeDrawGUIMethod(-603414435)]
		public static bool InstanceOperiaon_Draw_set_bScene(GraphNode pNode)
		{
			bool bChanged = false;
			if(!bChanged && (pNode.BindNode.inArgvs == null || pNode.BindNode.inArgvs.Length != 1)) bChanged = true;
			if(bChanged)
		...
		[GraphNodeDrawGUIMethod(1785646081)]
		public static bool InstanceOperiaon_Draw_get_bAsync(GraphNode pNode)
		{
			bool bChanged = false;
			if(!bChanged && (pNode.BindNode.outArgvs == null || pNode.BindNode.outArgvs.Length != 1)) bChanged = true;
			if(bChanged)
		...
		[GraphNodeDrawGUIMethod(1785646081)]
		public static bool InstanceOperiaon_Draw_set_bAsync(GraphNode pNode)
		{
			bool bChanged = false;
			if(!bChanged && (pNode.BindNode.inArgvs == null || pNode.BindNode.inArgvs.Length != 1)) bChanged = true;
			if(bChanged)
