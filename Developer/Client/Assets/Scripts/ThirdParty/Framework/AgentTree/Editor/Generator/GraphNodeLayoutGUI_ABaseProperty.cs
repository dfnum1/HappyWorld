...
namespace Framework.Plugin.AT
{
	...
	{
		[GraphNodeDrawGUIMethod(1674466214)]
		public static bool Framework_Core_ABaseProperty_SetLoop_ELoopTypeInt32Void(GraphNode pNode)
		{
			bool bChanged = false;
		...
		[GraphNodeDrawGUIMethod(-284538173)]
		public static bool Framework_Core_ABaseProperty_SetRuntimeTime_SingleVoid(GraphNode pNode)
		{
			bool bChanged = false;
		...
		[GraphNodeDrawGUIMethod(1371160238)]
		public static bool Framework_Core_ABaseProperty_SetDelayTime_SingleVoid(GraphNode pNode)
		{
			bool bChanged = false;
			if(!bChanged && (pNode.BindNode.inArgvs == null || pNode.BindNode.inArgvs.Length != 2)) bChanged = true;
			if(bChanged)
