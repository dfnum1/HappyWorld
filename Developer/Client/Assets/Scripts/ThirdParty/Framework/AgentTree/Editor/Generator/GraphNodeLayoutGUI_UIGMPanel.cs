...
namespace Framework.Plugin.AT
{
	...
	{
		[GraphNodeDrawGUIMethod(-413614972)]
		public static bool TopGame_UI_UIGMPanel_OnClickAddEquip_Void(GraphNode pNode)
		{
			bool bChanged = false;
		...
		[GraphNodeDrawGUIMethod(-2043298343)]
		public static bool TopGame_UI_UIGMPanel_OnClickAddElementEquip_Void(GraphNode pNode)
		{
			bool bChanged = false;
			if(!bChanged && (pNode.BindNode.inArgvs == null || pNode.BindNode.inArgvs.Length != 1)) bChanged = true;
			if(bChanged)
		...
		[GraphNodeDrawGUIMethod(1736797148)]
		public static bool TopGame_UI_UIGMPanel_OnCommitInputCode_StringVoid(GraphNode pNode)
		{
			bool bChanged = false;
