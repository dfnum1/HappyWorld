...
namespace Framework.Plugin.AT
{
	...
	{
		[GraphNodeDrawGUIMethod(1997564683)]
		public static bool TopGame_UI_TransitionPanel_GetMode_EMode(GraphNode pNode)
		{
			bool bChanged = false;
		...
		[GraphNodeDrawGUIMethod(1953355092)]
		public static bool TopGame_UI_TransitionPanel_SetSprite_SpriteVoid(GraphNode pNode)
		{
			bool bChanged = false;
