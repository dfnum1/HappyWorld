...
namespace Framework.Plugin.AT
{
	...
	{
		[GraphNodeDrawGUIMethod(-694021954)]
		public static bool Framework_Core_DyncmicTransformCollects_FindTransformByName_StringTransform(GraphNode pNode)
		{
			bool bChanged = false;
		...
		[GraphNodeDrawGUIMethod(-667608332)]
		public static bool Framework_Core_DyncmicTransformCollects_FindTransformByGUID_Int32Transform(GraphNode pNode)
		{
			bool bChanged = false;
			if(!bChanged && (pNode.BindNode.inArgvs == null || pNode.BindNode.inArgvs.Length != 2)) bChanged = true;
			if(!bChanged && (pNode.BindNode.outArgvs == null || pNode.BindNode.outArgvs.Length != 1)) bChanged = true;
		...
		[GraphNodeDrawGUIMethod(1782924016)]
		public static bool Framework_Core_DyncmicTransformCollects_ActiveNodeByGUID_Int32BooleanBooleanVoid(GraphNode pNode)
		{
			bool bChanged = false;
		...
		[GraphNodeDrawGUIMethod(-311412660)]
		public static bool Framework_Core_DyncmicTransformCollects_ActiveNodeByName_StringBooleanBooleanVoid(GraphNode pNode)
		{
			bool bChanged = false;
			if(!bChanged && (pNode.BindNode.inArgvs == null || pNode.BindNode.inArgvs.Length != 4)) bChanged = true;
			if(bChanged)
