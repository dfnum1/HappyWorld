...
namespace Framework.Plugin.AT
{
	...
	{
		[GraphNodeDrawGUIMethod(955617704)]
		public static bool TopGame_Core_AnimPathManager_PausePlay_BooleanVoid(GraphNode pNode)
		{
			bool bChanged = false;
		...
		[GraphNodeDrawGUIMethod(-1665165138)]
		public static bool TopGame_Core_AnimPathManager_DoSkipEvent_Void(GraphNode pNode)
		{
			bool bChanged = false;
		...
		[GraphNodeDrawGUIMethod(1072198510)]
		public static bool TopGame_Core_AnimPathManager_TrackBind_StringAInstanceAbleIUserDataInt32BooleanVoid(GraphNode pNode)
		{
			bool bChanged = false;
		...
		[GraphNodeDrawGUIMethod(-183764283)]
		public static bool TopGame_Core_AnimPathManager_HadBindTrack_StringAInstanceAbleInt32Boolean(GraphNode pNode)
		{
			bool bChanged = false;
		...
		[GraphNodeDrawGUIMethod(220258364)]
		public static bool TopGame_Core_AnimPathManager_HadBindTrackByUserData_StringIUserDataInt32Boolean(GraphNode pNode)
		{
			bool bChanged = false;
			if(!bChanged && (pNode.BindNode.inArgvs == null || pNode.BindNode.inArgvs.Length != 4)) bChanged = true;
			if(!bChanged && (pNode.BindNode.outArgvs == null || pNode.BindNode.outArgvs.Length != 1)) bChanged = true;
		...
		[GraphNodeDrawGUIMethod(91311908)]
		public static bool TopGame_Core_AnimPathManager_SkipTo_SingleInt32Void(GraphNode pNode)
		{
			bool bChanged = false;
		...
		[GraphNodeDrawGUIMethod(-1514673165)]
		public static bool TopGame_Core_AnimPathManager_EnableEvent_BooleanInt32Void(GraphNode pNode)
		{
			bool bChanged = false;
			if(!bChanged && (pNode.BindNode.inArgvs == null || pNode.BindNode.inArgvs.Length != 3)) bChanged = true;
			if(bChanged)
		...
		[GraphNodeDrawGUIMethod(1125653384)]
		public static bool TopGame_Core_AnimPathManager_Stop_Int32Void(GraphNode pNode)
		{
			bool bChanged = false;
			if(!bChanged && (pNode.BindNode.inArgvs == null || pNode.BindNode.inArgvs.Length != 2)) bChanged = true;
			if(bChanged)
		...
		[GraphNodeDrawGUIMethod(1930804528)]
		public static bool TopGame_Core_AnimPathManager_IsPlaying_Boolean(GraphNode pNode)
		{
			bool bChanged = false;
			if(!bChanged && (pNode.BindNode.inArgvs == null || pNode.BindNode.inArgvs.Length != 1)) bChanged = true;
			if(!bChanged && (pNode.BindNode.outArgvs == null || pNode.BindNode.outArgvs.Length != 1)) bChanged = true;
		...
		[GraphNodeDrawGUIMethod(852744778)]
		public static bool TopGame_Core_AnimPathManager_IsPlaying_1_Int32Boolean(GraphNode pNode)
		{
			bool bChanged = false;
			if(!bChanged && (pNode.BindNode.inArgvs == null || pNode.BindNode.inArgvs.Length != 2)) bChanged = true;
			if(!bChanged && (pNode.BindNode.outArgvs == null || pNode.BindNode.outArgvs.Length != 1)) bChanged = true;
