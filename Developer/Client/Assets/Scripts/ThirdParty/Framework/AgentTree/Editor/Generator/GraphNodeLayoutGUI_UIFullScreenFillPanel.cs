...
namespace Framework.Plugin.AT
{
	...
	{
		[GraphNodeDrawGUIMethod(1294942679)]
		public static bool TopGame_UI_UIFullScreenFillPanel_SetFillColor_ColorVoid(GraphNode pNode)
		{
			bool bChanged = false;
			...
			if(bChanged)
			{
				...
				{
					Port pvar=null;
					pvar = AgentTreeEditorUtils.BuildOriVariableCommonNew<Framework.Plugin.AT.VariableColor>(pVarsFactor, vInTemp, 1);
					pNode.BindNode.AddInPort(pvar);
				}
				pNode.BindNode.Save();
			}
		...
		[GraphNodeDrawGUIMethod(566349986)]
		public static bool TopGame_UI_UIFullScreenFillPanel_SetBeginTween_Void(GraphNode pNode)
		{
			bool bChanged = false;
		...
		[GraphNodeDrawGUIMethod(205230711)]
		public static bool TopGame_UI_UIFullScreenFillPanel_SetBeginTween_1_SingleVoid(GraphNode pNode)
		{
			bool bChanged = false;
			if(!bChanged && (pNode.BindNode.inArgvs == null || pNode.BindNode.inArgvs.Length != 2)) bChanged = true;
			if(bChanged)
		...
		[GraphNodeDrawGUIMethod(-978133061)]
		public static bool TopGame_UI_UIFullScreenFillPanel_SetEndTween_Void(GraphNode pNode)
		{
			bool bChanged = false;
			if(!bChanged && (pNode.BindNode.inArgvs == null || pNode.BindNode.inArgvs.Length != 1)) bChanged = true;
			if(bChanged)
		...
		[GraphNodeDrawGUIMethod(-916072722)]
		public static bool TopGame_UI_UIFullScreenFillPanel_SetEndTween_1_SingleVoid(GraphNode pNode)
		{
			bool bChanged = false;
			if(!bChanged && (pNode.BindNode.inArgvs == null || pNode.BindNode.inArgvs.Length != 2)) bChanged = true;
			if(bChanged)
		...
		[GraphNodeDrawGUIMethod(2065444057)]
		public static bool TopGame_UI_UIFullScreenFillPanel_GetState_State(GraphNode pNode)
		{
			bool bChanged = false;
			if(!bChanged && (pNode.BindNode.inArgvs == null || pNode.BindNode.inArgvs.Length != 1)) bChanged = true;
