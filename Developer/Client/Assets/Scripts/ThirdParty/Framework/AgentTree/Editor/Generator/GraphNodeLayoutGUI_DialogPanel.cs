...
namespace Framework.Plugin.AT
{
	...
	{
		[GraphNodeDrawGUIMethod(900571167)]
		public static bool TopGame_UI_DialogPanel_GetCurDialogData_DialogData(GraphNode pNode)
		{
			bool bChanged = false;
		...
		[GraphNodeDrawGUIMethod(745733841)]
		public static bool TopGame_UI_DialogPanel_GoNextDialog_Boolean(GraphNode pNode)
		{
			bool bChanged = false;
			if(!bChanged && (pNode.BindNode.inArgvs == null || pNode.BindNode.inArgvs.Length != 1)) bChanged = true;
			if(!bChanged && (pNode.BindNode.outArgvs == null || pNode.BindNode.outArgvs.Length != 1)) bChanged = true;
		...
		[GraphNodeDrawGUIMethod(401653215)]
		public static bool TopGame_UI_DialogPanel_SetPlayerHud_Void(GraphNode pNode)
		{
			bool bChanged = false;
			if(!bChanged && (pNode.BindNode.inArgvs == null || pNode.BindNode.inArgvs.Length != 1)) bChanged = true;
			if(bChanged)
		...
		[GraphNodeDrawGUIMethod(-1754166831)]
		public static bool TopGame_UI_DialogPanel_ShowDialog_UInt32SingleBoolean(GraphNode pNode)
		{
			bool bChanged = false;
