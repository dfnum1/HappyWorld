...
namespace Framework.Plugin.AT
{
	...
	{
		[GraphNodeDrawGUIMethod(871160379)]
		public static bool TopGame_Data_PermanentAssetsUtil_GetAsset_EPermanentAssetTypeObject(GraphNode pNode)
		{
			bool bChanged = false;
		...
		[GraphNodeDrawGUIMethod(-561002723)]
		public static bool TopGame_Data_PermanentAssetsUtil_GetElementEffectMaterial_EElementTypeMaterial(GraphNode pNode)
		{
			bool bChanged = false;
			if(!bChanged && (pNode.BindNode.inArgvs == null || pNode.BindNode.inArgvs.Length != 2)) bChanged = true;
			if(!bChanged && (pNode.BindNode.outArgvs == null || pNode.BindNode.outArgvs.Length != 1)) bChanged = true;
