...
namespace Framework.Plugin.AT
{
	...
	{
		[GraphNodeDrawGUIMethod(1873846443)]
		public static bool TopGame_Core_CameraController_GetCamera_Camera(GraphNode pNode)
		{
			bool bChanged = false;
		...
		[GraphNodeDrawGUIMethod(937004037)]
		public static bool TopGame_Core_CameraController_GetCamera_1_ECameraTypeCamera(GraphNode pNode)
		{
			bool bChanged = false;
			...
			if(bChanged)
			{
				...
				pNode.BindNode.ClearArgv();
				{
					...
					pvar.GetVariable<Framework.Plugin.AT.VariableInt>().mValue = 1;//Framework.Core.ECameraType.Force
		...
		[GraphNodeDrawGUIMethod(-83054029)]
		public static bool TopGame_Core_CameraController_UpdateFov_SingleVoid(GraphNode pNode)
		{
			bool bChanged = false;
			if(!bChanged && (pNode.BindNode.inArgvs == null || pNode.BindNode.inArgvs.Length != 1)) bChanged = true;
			if(bChanged)
		...
		[GraphNodeDrawGUIMethod(1796073115)]
		public static bool TopGame_Core_CameraController_SwitchMode_StringBooleanCameraMode(GraphNode pNode)
		{
			bool bChanged = false;
			...
			if(bChanged)
			{
				...
				{
					Port pvar=null;
					pvar = AgentTreeEditorUtils.BuildOriVariableCommonNew<Framework.Plugin.AT.VariableString>(pVarsFactor, vInTemp, 0);
					pNode.BindNode.AddInPort(pvar);
				}
				{
					Port pvar=null;
		...
		[GraphNodeDrawGUIMethod(-1592752874)]
		public static bool TopGame_Core_CameraController_GetCurrentMode_CameraMode(GraphNode pNode)
		{
			bool bChanged = false;
			if(!bChanged && (pNode.BindNode.outArgvs == null || pNode.BindNode.outArgvs.Length != 1)) bChanged = true;
			if(bChanged)
		...
		[GraphNodeDrawGUIMethod(62086956)]
		public static bool TopGame_Core_CameraController_GetDir_Vector3(GraphNode pNode)
		{
			bool bChanged = false;
			if(!bChanged && (pNode.BindNode.outArgvs == null || pNode.BindNode.outArgvs.Length != 1)) bChanged = true;
			if(bChanged)
		...
		[GraphNodeDrawGUIMethod(1869553528)]
		public static bool TopGame_Core_CameraController_GetRight_Vector3(GraphNode pNode)
		{
			bool bChanged = false;
			if(!bChanged && (pNode.BindNode.outArgvs == null || pNode.BindNode.outArgvs.Length != 1)) bChanged = true;
			if(bChanged)
		...
		[GraphNodeDrawGUIMethod(462930481)]
		public static bool TopGame_Core_CameraController_GetUp_Vector3(GraphNode pNode)
		{
			bool bChanged = false;
			if(!bChanged && (pNode.BindNode.outArgvs == null || pNode.BindNode.outArgvs.Length != 1)) bChanged = true;
			if(bChanged)
		...
		[GraphNodeDrawGUIMethod(-176104711)]
		public static bool TopGame_Core_CameraController_GetPosition_Vector3(GraphNode pNode)
		{
			bool bChanged = false;
			if(!bChanged && (pNode.BindNode.outArgvs == null || pNode.BindNode.outArgvs.Length != 1)) bChanged = true;
			if(bChanged)
		...
		[GraphNodeDrawGUIMethod(1152016935)]
		public static bool TopGame_Core_CameraController_GetEulerAngle_Vector3(GraphNode pNode)
		{
			bool bChanged = false;
			if(!bChanged && (pNode.BindNode.outArgvs == null || pNode.BindNode.outArgvs.Length != 1)) bChanged = true;
			if(bChanged)
		...
		[GraphNodeDrawGUIMethod(846133601)]
		public static bool TopGame_Core_CameraController_GetCurrentLookAt_Vector3(GraphNode pNode)
		{
			bool bChanged = false;
			if(!bChanged && (pNode.BindNode.outArgvs == null || pNode.BindNode.outArgvs.Length != 1)) bChanged = true;
			if(bChanged)
		...
		[GraphNodeDrawGUIMethod(574897287)]
		public static bool TopGame_Core_CameraController_GetCurrentFollowLookAt_Vector3(GraphNode pNode)
		{
			bool bChanged = false;
			if(!bChanged && (pNode.BindNode.outArgvs == null || pNode.BindNode.outArgvs.Length != 1)) bChanged = true;
			if(bChanged)
		...
		[GraphNodeDrawGUIMethod(1585642957)]
		public static bool TopGame_Core_CameraController_StopAllEffect_Void(GraphNode pNode)
		{
			bool bChanged = false;
			if(bChanged)
			{
		...
		[GraphNodeDrawGUIMethod(181856445)]
		public static bool TopGame_Core_CameraController_Shake_SingleVector3Vector3AnimationCurveVoid(GraphNode pNode)
		{
			bool bChanged = false;
		...
		[GraphNodeDrawGUIMethod(-1131141808)]
		public static bool TopGame_Core_CameraController_CloseUp_TransformVector3Vector3Vector3SingleVoid(GraphNode pNode)
		{
			bool bChanged = false;
			...
			if(bChanged)
			{
				...
				{
					Port pvar=null;
					pvar = AgentTreeEditorUtils.BuildOriVariableCommonNew<Framework.Plugin.AT.VariableObject>(pVarsFactor, vInTemp, 0);
					pNode.BindNode.AddInPort(pvar);
				}
				{
					Port pvar=null;
		...
		[GraphNodeDrawGUIMethod(-577737157)]
		public static bool TopGame_Core_CameraController_PlayAniPath_Int32GameObjectBooleanSingleSingleSingleIPlayableBase(GraphNode pNode)
		{
			bool bChanged = false;
		...
		[GraphNodeDrawGUIMethod(653244172)]
		public static bool TopGame_Core_CameraController_IsInView_Vector3SingleBoolean(GraphNode pNode)
		{
			bool bChanged = false;
			if(!bChanged && (pNode.BindNode.inArgvs == null || pNode.BindNode.inArgvs.Length != 2)) bChanged = true;
			if(!bChanged && (pNode.BindNode.outArgvs == null || pNode.BindNode.outArgvs.Length != 1)) bChanged = true;
			if(bChanged)
			{
				...
				{
					Port pvar=null;
					pvar = AgentTreeEditorUtils.BuildOriVariableCommonNew<Framework.Plugin.AT.VariableVector3>(pVarsFactor, vInTemp, 0);
					pNode.BindNode.AddInPort(pvar);
				}
				{
					Port pvar=null;
