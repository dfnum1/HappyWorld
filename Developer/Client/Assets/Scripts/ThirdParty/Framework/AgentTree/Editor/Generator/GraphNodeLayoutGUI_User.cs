...
namespace Framework.Plugin.AT
{
	...
	{
		[GraphNodeDrawGUIMethod(837976054)]
		public static bool TopGame_SvrData_User_SetLocationState_ELocationStateVoid(GraphNode pNode)
		{
			bool bChanged = false;
		...
		[GraphNodeDrawGUIMethod(1919035152)]
		public static bool TopGame_SvrData_User_GetLocationState_ELocationState(GraphNode pNode)
		{
			bool bChanged = false;
