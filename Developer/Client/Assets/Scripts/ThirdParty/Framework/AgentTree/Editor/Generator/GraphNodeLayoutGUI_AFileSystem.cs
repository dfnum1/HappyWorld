...
namespace Framework.Plugin.AT
{
	...
	{
		[GraphNodeDrawGUIMethod(1473547718)]
		public static bool Framework_Core_AFileSystem_ClearAllPreSpawn_SingleVoid(GraphNode pNode)
		{
			bool bChanged = false;
		...
		[GraphNodeDrawGUIMethod(-1441835282)]
		public static bool Framework_Core_AFileSystem_GetPreSpawnStats_StringInt32(GraphNode pNode)
		{
			bool bChanged = false;
			if(!bChanged && (pNode.BindNode.inArgvs == null || pNode.BindNode.inArgvs.Length != 2)) bChanged = true;
		...
		[GraphNodeDrawGUIMethod(543942497)]
		public static bool Framework_Core_AFileSystem_GetPreSpawnStats_1_GameObjectInt32(GraphNode pNode)
		{
			bool bChanged = false;
			if(!bChanged && (pNode.BindNode.inArgvs == null || pNode.BindNode.inArgvs.Length != 2)) bChanged = true;
			if(!bChanged && (pNode.BindNode.outArgvs == null || pNode.BindNode.outArgvs.Length != 1)) bChanged = true;
		...
		[GraphNodeDrawGUIMethod(418262539)]
		public static bool Framework_Core_AFileSystem_PreSpawnInstance_StringBooleanBooleanVoid(GraphNode pNode)
		{
			bool bChanged = false;
		...
		[GraphNodeDrawGUIMethod(1846438530)]
		public static bool Framework_Core_AFileSystem_PreSpawnInstance_1_GameObjectBooleanVoid(GraphNode pNode)
		{
			bool bChanged = false;
		...
		[GraphNodeDrawGUIMethod(-1559568525)]
		public static bool Framework_Core_AFileSystem_SpawnInstance_StringBooleanInstanceOperiaon(GraphNode pNode)
		{
			bool bChanged = false;
			if(!bChanged && (pNode.BindNode.inArgvs == null || pNode.BindNode.inArgvs.Length != 3)) bChanged = true;
			if(bChanged)
		...
		[GraphNodeDrawGUIMethod(-1671274047)]
		public static bool Framework_Core_AFileSystem_SpawnInstance_1_GameObjectBooleanInstanceOperiaon(GraphNode pNode)
		{
			bool bChanged = false;
			if(!bChanged && (pNode.BindNode.inArgvs == null || pNode.BindNode.inArgvs.Length != 3)) bChanged = true;
			if(bChanged)
