...
namespace Framework.Plugin.AT
{
	...
	{
		[GraphNodeDrawGUIMethod(1324311230)]
		public static bool TopGame_UI_UISerialized_Visible_Void(GraphNode pNode)
		{
			bool bChanged = false;
		...
		[GraphNodeDrawGUIMethod(1443379720)]
		public static bool TopGame_UI_UISerialized_Hidden_Void(GraphNode pNode)
		{
			bool bChanged = false;
			if(!bChanged && (pNode.BindNode.inArgvs == null || pNode.BindNode.inArgvs.Length != 1)) bChanged = true;
			if(bChanged)
		...
		[GraphNodeDrawGUIMethod(-246436151)]
		public static bool TopGame_UI_UISerialized_Find_StringGameObject(GraphNode pNode)
		{
			bool bChanged = false;
