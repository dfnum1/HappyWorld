...
namespace MagicaCloth
{
    public class WindController : MonoBehaviour
    {
        ...
        private MagicaDirectionalWind magicaDirectionalWind;
        ...
        void Awake()
        {
            magicaDirectionalWind = transform.GetComponent<MagicaDirectionalWind>();
        }
        ...
        private void OnEnable()
        {
            ...
            if (MagicaPhysicsManager.IsInstance())
                active = MagicaPhysicsManager.Instance.IsActive;
            if (unityWindZone)
            {
                unityWindZone.transform.gameObject.SetActive(active);
            }
            if (magicaDirectionalWind)
            {
                magicaDirectionalWind.enabled = active;
            }
        }
