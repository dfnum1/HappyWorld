...
{
    public static System.Action OnGameController = null;
#if USE_REPORTVIEW
	...
	void drawToolBar()
	{
        ...
        if (OnGameController!=null && GUILayout.Button("Game", GUILayout.Width(size.x * 3), GUILayout.Height(size.y * 2)))
        {
			OnGameController();
        }
	...
	public void OnGUIDraw()
	{
		...
		logsRect.width = Screen.width- leftGap;
