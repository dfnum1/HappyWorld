...
namespace FMODUnity
{
    ...
    public class RuntimeManager : MonoBehaviour
    {
        ...
        public static System.Action<string, FMOD.Studio.EventInstance, EventReference> OnFmodEventTrigger = null;

        private FMODFadeMixerManager m_FadeMixerManager = null;
...
retry:
        ...
        void Update()
        {
            if (studioSystem.isValid())
            {
                ...
                if(m_FadeMixerManager!=null) m_FadeMixerManager.Update();
            }
        }
        ...
        void HandlePlayModeStateChange(PlayModeStateChange state)
        {
            ...
            {
                if (state == PlayModeStateChange.ExitingEditMode && UnityEditor.EditorSettings.enterPlayModeOptionsEnabled &&
                    (UnityEditor.EditorSettings.enterPlayModeOptions | EnterPlayModeOptions.DisableDomainReload) != 0)
                {
        ...
        private void loadedBankRegister(LoadedBank loadedBank, string bankPath, string bankName, bool loadSamples, FMOD.RESULT loadResult)
        {
            ...
            {
                Debug.LogWarning("load bank :" + bankPath + "   result:" + loadResult);
        ...
        public static FMOD.GUID PathToGUID(string path)
        {
            ...
            else
            {
                ...
                {
                    Framework.Plugin.Logger.Warning(path);
                    return guid;
        ...
        public static void PlayOneShot(EventReference eventReference, Vector3 position = new Vector3())
        {
            ...
            catch (EventNotFoundException)
            {
                ...
                Framework.Plugin.Logger.Warning("[FMOD] Event not found: " + eventReference);
            }
        }
        ...
        public static FMOD.Studio.EventInstance PlayOneShot(FMOD.GUID guid, Vector3 position = new Vector3())
        {
        ...
        public static FMOD.Studio.EventInstance PlayOneShotAttached(FMOD.GUID guid, GameObject gameObject)
        {
            var instance = CreateInstance(guid);
            #if UNITY_PHYSICS_EXIST
        ...
        public static FMOD.Studio.EventDescription GetEventDescription(EventReference eventReference)
        {
            ...
            catch (EventNotFoundException ex)
            {
                //throw new EventNotFoundException(eventReference);
                Framework.Plugin.Logger.Warning(ex.ToString());
                return FMOD.Studio.EventDescription.DEFAULT;
            }
        }
        ...
        public static FMOD.Studio.EventDescription GetEventDescription(FMOD.GUID guid)
        {
            ...
            else
            {
                ...
                if (result != FMOD.RESULT.OK)
                {
                    Framework.Plugin.Logger.Warning(guid.ToString());
                    return FMOD.Studio.EventDescription.DEFAULT;
        ...
        public static void FadeMixer(string mixerGroup, FMOD.Studio.EventInstance eventInstance, float toFade)
        {
            if (string.IsNullOrEmpty(mixerGroup)) return;
            if (Instance == null) return;
            if (Instance.m_FadeMixerManager == null) Instance.m_FadeMixerManager = new FMODFadeMixerManager();
            Instance.m_FadeMixerManager.AddFadeMixer(mixerGroup, eventInstance, toFade);
        }
