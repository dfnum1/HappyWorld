    ...
    public class SetupWizardWindow : EditorWindow
    {
        ...
        void SourceControl()
        {
            ...
            using (new EditorGUILayout.HorizontalScope())
            {
                ...
                using (new EditorGUILayout.VerticalScope("box"))
                {
                    EditorGUILayout.TextField("# Never ignore DLLs in the FMOD subfolder.");
                    EditorGUILayout.TextField("!/[Aa]ssets/Plugins/FMOD/**/lib/*");
                    EditorGUILayout.Space();
                    EditorGUILayout.TextField("Don't ignore images and gizmos used by FMOD in the Unity Editor.");
                    EditorGUILayout.TextField("!/[Aa]ssets/Gizmos/FMOD/*");
                    EditorGUILayout.TextField("!/[Aa]ssets/Editor Default Resources/FMOD/*");
                    EditorGUILayout.Space();
                    EditorGUILayout.TextField("# Ignore the Cache folder since it is updated locally.");
                    EditorGUILayout.TextField("/[Aa]ssets/Plugins/FMOD/Cache/*");
                    EditorGUILayout.Space();
                    EditorGUILayout.TextField("# Ignore bank files in the StreamingAssets folder.");
                    EditorGUILayout.TextField("/[Aa]ssets/StreamingAssets/**/*.bank");
                    EditorGUILayout.TextField("/[Aa]ssets/StreamingAssets/**/*.bank.meta");
                    EditorGUILayout.Space();
                    EditorGUILayout.TextField("# If the source bank files are kept outside of the StreamingAssets folder then these can be ignored.");
                    EditorGUILayout.TextField("# Log files can be ignored.");
                    EditorGUILayout.TextField("fmod_editor.log");
                }
                GUILayout.FlexibleSpace();
            }
