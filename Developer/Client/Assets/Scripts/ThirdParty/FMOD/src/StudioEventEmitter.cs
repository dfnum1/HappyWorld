...
namespace FMODUnity
{
    ...
    public class StudioEventEmitter : EventHandler
    {
        ...
        public void PlayInstance()
        {
            ...
            instance.start();
            if(!string.IsNullOrEmpty(MixChannel) )
            {
                instance.setVolume(0);
                RuntimeManager.FadeMixer(MixChannel, instance, 1);
            }
            if (RuntimeManager.OnFmodEventTrigger != null)
                RuntimeManager.OnFmodEventTrigger(MixChannel, instance, EventReference);
        ...
        public void StopInstance()
        {
            ...
            if (instance.isValid())
            {
                ...
                {
                    RuntimeManager.FadeMixer(MixChannel, instance, 0);
                }
            }
        }
