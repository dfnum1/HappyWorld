...
// #endif
    ...
    {
        public static EventDescription DEFAULT = new EventDescription() { handle = IntPtr.Zero };
    ...
    {
        public static EventInstance DEFAULT = new EventInstance() { handle = IntPtr.Zero };
